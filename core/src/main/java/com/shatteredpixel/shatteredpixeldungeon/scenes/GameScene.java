...
public class GameScene extends PixelScene {
    ...
    public void create() {
        ...
        if (uiSize == 2) {
            ...
            toolbar.setRect(0, uiCamera.height - toolbar.height() - inventory.height(), uiCamera.width,
                    toolbar.height());
        } else {
        ...
        if (InterlevelScene.mode != InterlevelScene.Mode.NONE) {
            ...
            if (Dungeon.hero.hasTalent(Talent.ROGUES_FORESIGHT)
                ...
                // 50%/75% chance, use level's seed so that we get the same result for the same
                // level
    ...
    public static void gameOver() {
        ...
        StyledButton restart = new StyledButton(Chrome.Type.GREY_BUTTON_TR, "Restart", 9) {
            @Override
            protected void onClick() {
                GameScene.show(new WndGameInProgress(GamesInProgress.curSlot));
            }
        ...
        newGame.icon(Icons.get(Icons.ENTER));
        newGame.alpha(0);

...
public class SPDSettings extends GameSettings {
    ...
    public static final String KEY_HARDMODE = "hardcore_mode";
    ...
    public static void isHardcoreMode(boolean value) {
        put(KEY_HARDMODE, value);
    }

    public static boolean isHardcoreMode() {
        return getBoolean(KEY_HARDMODE, false);
    }
